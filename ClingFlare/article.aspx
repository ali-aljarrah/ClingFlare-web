            ...
            <div class="col-md-12">
                <div class="text-start">
                    <div class="text-center">
                     ...
                     <h1 class="fs-40 p-4 p-lg-0 secondary-color syne-font fw-bolder mb-4">
                          Product Launch: Detect Bots in Real-time with BotD
                     </h1>
                    <p class="fs-18 p-4 p-lg-0 dark-blue text-start">
                    ...
                    <h2 class="fs-28 p-4 p-lg-0 dark-blue fw-bolder mb-4">
                    ...
                    <h3 class="fs-28 p-4 p-lg-0 dark-blue fw-bolder mb-4">
