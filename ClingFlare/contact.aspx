    ...
    <section>
     <div class="container mt-5 pt-5">
         <div class="row mb-5 pb-5">
             ...
             <div class="col-md-6 offset-lg-1 mb-4 mt-3">
                 ...
                 <a href="#" class="text-decoration-none">
                     <div class="d-flex align-items-center mt-5">
                         ...
                         <p class="fs-16 dark-blue fw-500 px-3 mb-0">info@clingflare.com</p>
                     </div>
                 </a>
                 <a href="#" class="text-decoration-none">
                     <div class="d-flex align-items-center mt-5">
                        ...
                        <p class="fs-16 dark-blue fw-500 px-3 mb-0">08 888 2525</p>
                    </div>
                  </a>
                  <div class="d-flex align-items-center mt-5">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="fs-16 dark-blue fw-500 px-3 mb-0">Issue a ticket</p>
                 </div>
            </div>
         </div>
     </div>
